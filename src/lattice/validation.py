...
import inspect
import warnings
from lattice.module import Application, Module
        ...
        for module in app.modules:
            for provider in module.providers:
                for dependency in provider_dependencies(provider=provider):
                    dependency_accessible = any(dependency in imported_module.providers for imported_module in iter_submodules(module))
