...
from waku._lifespan import LifespanFunc, LifespanWrapper
...
class Application:
    def __init__(
        ...
        self._lifespan = tuple(LifespanWrapper(lifespan_func) for lifespan_func in lifespan)
    ...
    def _get_modules_for_triggering_extensions(self) -> list[ModuleMetadata]:
